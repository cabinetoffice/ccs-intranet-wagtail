...
dependency core_iam {
  ...
  mock_outputs = {
    ecs_deployer_step_function_arn  = "mock"
    ecs_deployer_step_function_name = "mock"
    ecs_task_arn                    = "mock"
...
dependency common_networking {
  ...
  mock_outputs = {
    ecs_alb_arn            = "mock"
    fqdn_application       = "mock"
    hosted_zone_public_id  = "mock"
...
dependency service_database {
  ...
  mock_outputs = {
    cache_redis_address = "mock"
    cache_redis_port    = "mock"
    db_name             = "mock"
    db_identifier       = "mock"
    db_postgres_address = "mock"
    db_postgres_port    = "mock"
  }
}
...
inputs = {
  ...
  role_ecs_deployer_step_function_arn  = dependency.core_iam.outputs.ecs_deployer_step_function_arn
  role_ecs_deployer_step_function_name = dependency.core_iam.outputs.ecs_deployer_step_function_name
  ...
  ecs_alb_arn            = dependency.common_networking.outputs.ecs_alb_arn
  fqdn_application       = dependency.common_networking.outputs.fqdn_application
  hosted_zone_public_id  = dependency.common_networking.outputs.hosted_zone_public_id
  ...
  cache_redis_sg_id         = dependency.core_security_groups.outputs.cache_redis_sg_id
  ...
  ecs_service_base_sg_id    = dependency.core_security_groups.outputs.ecs_service_base_sg_id
  ...
  cache_redis_address = dependency.service_database.outputs.cache_redis_address
  cache_redis_port    = dependency.service_database.outputs.cache_redis_port
  db_identifier       = dependency.service_database.outputs.db_identifier
  db_name             = dependency.service_database.outputs.db_name
  db_postgres_address = dependency.service_database.outputs.db_postgres_address
  db_postgres_port    = dependency.service_database.outputs.db_postgres_port
